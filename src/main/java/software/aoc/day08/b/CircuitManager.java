...
public class CircuitManager {
    ...
    private final List<Pair> lastPairs;
    ...
    public CircuitManager divideBoxesV2(int limit) {
    ...
    public long lastPairDistance() {
        return mulLast(lastPairs.get(0));
    }

    private long mulLast(Pair pair) {
        return toLong(pair.getLow().x() * pair.getHigh().x());
    }
